...
ELEGOO Smart Robot Car Kit V4.0 New 是一套基于 Arduino UNO 兼容主控的智能小车程序。当前代码版本为 `2.1.2`，主程序入口为 `SmartRobotCarV4.0.ino`。
...
在 Arduino IDE 中打开 `库管理器`，搜索并安装 `FastLED`。
